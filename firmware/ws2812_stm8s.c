...
#define WS2812_TARGET_PLATFORM_STM8S // 2025-05-21 Platima: Added due to how Arduino compiles - not defined at build time
...
#include "ws2812_common.h" // 2025-05-21 Platima: Changed to "";s due to local include
#include "ws2812_stm8s.h" // 2025-05-21 Platima: As above
